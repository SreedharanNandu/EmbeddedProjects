...
volatile unsigned char Edge_Timer ;
volatile unsigned char Encoder_Count;
volatile unsigned char Current_Encoder_A ;
volatile unsigned char Current_Encoder_B ;
volatile unsigned char Prior_Encoder_A ;
volatile unsigned char Prior_Encoder_B ;
volatile unsigned char Encoder_Missed_Edge ;
volatile unsigned char Edge_Faster ;
signed char Encoder_State;
volatile unsigned char Debounced_Signal_A_Changed ;
volatile unsigned char Debounced_Signal_B_Changed ;
signed char Prior_Encoder_State ;
volatile unsigned char Encoder_Debounce_Timer_A ;
volatile unsigned char Encoder_Debounce_Timer_B ;
