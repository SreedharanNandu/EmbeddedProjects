...
#define HAL_High_Speed_External_Clock_Stop_Control        CSC_bit.no7
#define HAL_Sub_clock_Operation_Stop_Control            CSC_bit.no6
#define HAL_High_Speed_Internal_Clock_Stop_Control        CSC_bit.no0
#define HAL_GUARD_Wrte_Enable_For_CSC_Reg             GUARD_bit.no0 
#define HAL_OSC_Stabilization_Time_Status_Reg           OSTC
#define HAL_Data_Flash_Operating_Freq                  OSMC_bit.no2
#define HAL_Code_Flash_Operating_Freq                  OSMC_bit.no0

#define HAL_System_Clock_Control_Reg                CKC
#define HAL_Main_System_Clock_Select                    CKC_bit.no4
#define HAL_CPU_Peripheral_Clock_Select                 CKC_bit.no6
