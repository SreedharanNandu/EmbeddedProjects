...
#define SYSTEM_CLOCK (unsigned long)20000000
#define CLKSPERINSTRUCTION (unsigned char)4
#define TMR1PRESCALER (unsigned char)1
#define TMR1OVERHEAD (unsigned char)5
#define MILLISECDELAY (unsigned long)((SYSTEM_CLOCK/CLKSPERINSTRUCTION/TMR1PRESCALER/(unsigned long)1000) - TMR1OVERHEAD)
