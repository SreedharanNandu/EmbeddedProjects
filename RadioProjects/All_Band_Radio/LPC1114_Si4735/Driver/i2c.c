...
void Init_I2C(void)
{
   ...
   LPC_I2C->SCLL = 60;//48Mhz/(240+240) = 100khz :120 for 400khz
   LPC_I2C->SCLH = 60;//NOTE:increasing speed affects RDS scanning freq due to I2C transaction timeout delay
